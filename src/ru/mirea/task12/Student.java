...
class StudentTest {
    ...
    private Student[] createFirstTestArr() {
        ...
        testArr[1] = (new Student(2, "Roma", 33));
        testArr[2] = (new Student(3, "Vova", 10));
        testArr[3] = (new Student(4, "Evgen", 13));
    ...
    private Student[] createSecondTestArr() {
        ...
        testArr[0] = (new Student(5, "Zhenya", 17));
        testArr[1] = (new Student(6, "Danila", 5));
        testArr[2] = (new Student(7, "Denis", 57));
